...
#write.csv(otpdata091515, file = "D:/Spring_19/Practicum/Material/Data/OTP_Travel_Data_60min.csv")

otpdata_filtered <- read.csv("travel_time_60min_transit.csv")
...
#Less than 2 hours
alldata091515U30 = alldata091515[which(alldata091515$travel_time<3600),]
...
write.csv(Final, file = "D:/Spring_19/Practicum/Material/Data/Jobs_Accessible_60min.csv")
...
write.csv(merged_data, file = "D:/Spring_19/Practicum/Material/Data/jobs_workers_origin_test.csv")
