...
setwd("D:/Spring_19/Practicum/Material/OTP/Car_Transit_30min")
...
write.csv(otpdata091515, file = "D:/Spring_19/Practicum/Material/Data/Car_OTP_Travel_Data_30min.csv")

otpdata_filtered <- read.csv("D:/Spring_19/Practicum/Material/Data/Car_OTP_Travel_Data_30min.csv")
...
write.csv(Final, file = "D:/Spring_19/Practicum/Material/Data/Jobs_Accessable_60.csv")
...
write.csv(merged_data, file = "D:/Spring_19/Practicum/Material/Data/car_jobs_workers_origin_test_30min.csv")
